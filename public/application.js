...
var apiUrl = __webpack_require__(8);
...
var getImagesByDistance = function getImagesByDistance() {
  return $.ajax({
...
var findImageById = function findImageById(id) {
  return $.ajax({
...
module.exports = {
  ...
  getImages: getImages,
  getImagesByDistance: getImagesByDistance
};
...
var addNestedValue = __webpack_require__(18);
...
var store = __webpack_require__(2);
var templateCarousel = __webpack_require__(38);
var templateMyImages = __webpack_require__(10);
...
var populateCarousel = function populateCarousel(data) {
  var carouselReadout = templateCarousel({ images: data.images });
  $('#carousel-inner').append(carouselReadout);
  $('#carousel-inner').find('.item').first().addClass('active');
};

var populateCarouselSuccess = function populateCarouselSuccess(data) {
  var nonUserImages = data.images.filter(function (image) {
  ...
  if (nonUserImages.length < 1) {
    api.getImages().then(function (data) {
      if (data > 1) {
...
var onGetMyImagesSuccess = function onGetMyImagesSuccess(response) {
  $('#upload-images-page').hide();
  $('#carousel-view').hide();
  $('#my-images-page').show();
  $('#map-view').hide();
  ...
  var personalImagesArr = response.images.filter(function (image) {
    return image._owner.email === store.user.email;
  });
  if (personalImagesArr.length === 0) {
    ...
    for (var _i = 0; _i < response.images.length; _i++) {
      $("div[data-id='image-" + response.images[_i]._id + "']").css('background-image', 'url(' + response.images[_i].url + ')');
    }
  }
};
...
var onGetImagesForMap = function onGetImagesForMap(data) {
  $('#upload-images-page').hide();
  $('#carousel-view').hide();
  $('#my-images-page').hide();
  $('#map-view').show();
  ...
  data.images.forEach(function (image) {
    var imageLatLng = { lat: image.loc[1], lng: image.loc[0] };

    var contentString = '<div id="content">' + '<h4>Title: </h4>' + image.title + '<br>' + '<h4> Description: </h4>' + image.description + '<br>' + '<h4> Latitude:</h4> ' + image.loc[1] + '<br>' + '<h4>Longitude:</h4>' + image.loc[0] + '<br>' + '</div>';
...
module.exports = {
  ...
  onGetMyImagesSuccess: onGetMyImagesSuccess,
  onGetImagesForMap: onGetImagesForMap
};
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(0)))
...
var commentEvents = __webpack_require__(43);
var userEvents = __webpack_require__(5);
...
var getUserLocationTimeout = function getUserLocationTimeout() {
...
var getFormFields = __webpack_require__(6);
var api = __webpack_require__(4);
var getExifData = __webpack_require__(40);
var store = __webpack_require__(2);

var imageHandlers = function imageHandlers() {
...
var onSelectMap = function onSelectMap() {
  api.getImages().then(ui.onGetImagesForMap);
};
...
var onSelectCarousel = function onSelectCarousel(event) {
  ...
  api.findImageById(imageId).then(ui.populateCarouselModalSuccess).catch(ui.populateCarouselModalFailure);
};

var onReturnToCarouselView = function onReturnToCarouselView(event) {
  event.preventDefault();
  if (store.user.latitude && store.user.longitude) {
    api.getImagesByDistance().then(ui.populateCarouselSuccess).catch(ui.populateCarouselFailure);
  } else {
...
var onSelectViewMyImagesView = function onSelectViewMyImagesView(event) {
  event.preventDefault();
  api.getImages().then(ui.onGetMyImagesSuccess).catch(ui.onGetMyImagesFailure);
};
...
var dms2dec = __webpack_require__(41); // GPS coord to decimal converter
var EXIF = __webpack_require__(42); // Require exif-js npm module
var store = __webpack_require__(2);
var notification = __webpack_require__(9);
...
var commentHandlers = function commentHandlers() {
